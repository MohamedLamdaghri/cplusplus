...
circuito::Puerta::Puerta (const std::string id_puerta_, const std::string tipo_puerta_, const int r_hl ,const int r_lh, const int num_entradas) :
 in_pins (num_entradas), id_puerta {id_puerta_}, r_hl {r_hl}, r_lh {r_lh},tipo_puerta {tipo_puerta_} {
    out_pin.puerta = this;
